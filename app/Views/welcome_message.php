...
<head>
    ...
    <!-- Custom styles for CodeIgniter branding -->
    <style {csp-style-nonce}>
        .ci-orange { color: #dd4814; }
        .bg-ci-orange { background-color: #dd4814; }
        .bg-ci-orange-light { background-color: rgba(221, 72, 20, 0.8); }
        .svg-stroke {
            fill: none;
            stroke: #000;
            stroke-width: 32px;
...
<header class="bg-gray-50">
    ...
    <div class="px-8 py-2">
        <ul class="flex items-center justify-between border-b border-gray-200 pb-4">
            <li class="logo">
                <a href="https://codeigniter.com" target="_blank" class="block">
